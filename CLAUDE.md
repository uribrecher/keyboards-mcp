...
See the [Sounds and Recreation README](packages/sounds-and-recreation-app/README.md#transport-codec-handler--runtime-contract) for the full message-flow diagrams.
