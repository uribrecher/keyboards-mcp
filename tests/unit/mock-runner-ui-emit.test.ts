/**
 * MockEngine external-MIDI dispatch (#30 stage 5).
 *
 * Stage 5 dropped UI-source dispatch and handler.onMIDI entirely. The
 * engine now only routes EXTERNAL MIDI through codec → handler. UI
