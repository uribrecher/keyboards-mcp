...
import type { MockHandlerV2, MidiMessage, MockHandlerResult } from "../../../shared/keyboard-model.js";
...
export function createNordElectro5DMockHandlerV2(): MockHandlerV2 {
  // ── Channels ──
  let lowerChannel = 1;
  let upperChannel = 2;
