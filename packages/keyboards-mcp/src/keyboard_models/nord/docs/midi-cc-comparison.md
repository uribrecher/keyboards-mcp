...
| 16  | Organ Drawbar 1                  | `drawbar_1`                  | Drawbar encoding (0-8)       |
| 17  | Organ Drawbar 2                  | `drawbar_2`                  | Drawbar encoding (0-8)       |
| 18  | Organ Drawbar 3                  | `drawbar_3`                  | Drawbar encoding (0-8)       |
| 19  | Organ Drawbar 4                  | `drawbar_4`                  | Drawbar encoding (0-8)       |
| 20  | Organ Drawbar 5                  | `drawbar_5`                  | Drawbar encoding (0-8)       |
| 21  | Organ Drawbar 6                  | `drawbar_6`                  | Drawbar encoding (0-8)       |
| 22  | Organ Drawbar 7                  | `drawbar_7`                  | Drawbar encoding (0-8)       |
| 23  | Organ Drawbar 8                  | `drawbar_8`                  | Drawbar encoding (0-8)       |
| 24  | Organ Drawbar 9                  | `drawbar_9`                  | Drawbar encoding (0-8)       |
...
| 36  | Sample Synth Dynamics            | `sample_synth_dynamics`      | Discrete: Off/Low/Mid/High   |
| 37  | Sample Synth Filter Velocity     | `sample_synth_filter_vel`    |                              |
| 39  | Part Lower Engine Select         | `part_lower_engine_select`   |                              |
| 40  | Part Upper Engine Select         | `part_upper_engine_select`   |                              |
...
| 45  | Piano Variation                  | `piano_variation`            | Clav A/B/C/D, modelIndex     |
| 46  | Piano KBD Touch                  | `piano_kbd_touch`            | Discrete: Touch 1-4          |
| 48  | Program/Set List Mode            | `program_setlist_mode`       | Handled by mock handler      |
| 49  | Set List Part Select             | `setlist_part_select`        | Handled by mock handler      |
| 50  | KB Split Mode                    | `kb_split_mode`              |                              |
| 51  | KB Split Point                   | `kb_split_point`             |                              |
| 52  | Transpose Enable                 | `transpose_enable`           |                              |
| 53  | Transpose Amount                 | `transpose_amount`           |                              |
| 54  | Octave Shift Part Lower          | `octave_shift_lower`         |                              |
| 55  | Octave Shift Part Upper          | `octave_shift_upper`         |                              |
| 56  | Sustain Pedal Enable Lower       | `sustain_pedal_enable_lower` |                              |
| 57  | Sustain Pedal Enable Upper       | `sustain_pedal_enable_upper` |                              |
| 58  | Ctrl Pedal Enable Lower          | `ctrl_pedal_enable_lower`    |                              |
| 59  | Ctrl Pedal Enable Upper          | `ctrl_pedal_enable_upper`    |                              |
| 60  | Effect 1 Type                    | `effect1_type`               |                              |
| 61  | Effect 2 Type                    | `effect2_type`               | Includes Vibe (index 5)      |
...
| 98  | Piano Acoustic                   | `piano_acoustic`             | Off/StrRes/LongRel/Both      |
| 102 | Reverb Dry/Wet                   | `reverb_dry_wet`             |                              |
| 103 | Delay Dry/Wet                    | `delay_dry_wet`              |                              |
| 104 | Delay Feedback                   | `delay_feedback`             | Discrete: 0/1/2/3            |
...
| 118 | EQ Bass                          | `eq_bass`                    |                              |
| 119 | EQ Part Select                   | `eq_part_select`             | Supports Lower/Upper/Both    |
