...
export const PARAMS: Record<string, KeyboardParameter> = {
  ...
  arp_mode: {
    ...
    type: "discrete",
    labels: { 0: "Up", 1: "Down", 2: "Up/Down", 3: "Random", 4: "Assign" },
  ...
  arp_range: {
    ...
    type: "discrete",
    labels: { 0: "1 Oct", 1: "2 Oct", 2: "3 Oct" },
  ...
  arp_time_signature: {
    ...
    type: "discrete",
    labels: { 0: "Half", 1: "Qtr", 2: "8th", 3: "8th D", 4: "8th S", 5: "8th T", 6: "16th", 7: "16th S", 8: "16th T", 9: "32nd" },
  ...
  glide_mode: {
    ...
    type: "discrete",
    labels: { 0: "Fixed Rate", 1: "Fixed Rate A", 2: "Fixed Time", 3: "Fixed Time A" },
